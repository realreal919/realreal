...
\restrict 8qkaYjPDcEpiqT9b2pJf3sePwBCV4BCHdCqbskATWFfA2yxCwvMMsB8fLEwqmyI
...
--
-- Name: decrypt_token(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.decrypt_token(cipher_text text, encryption_key text) RETURNS text
...
ALTER FUNCTION public.decrypt_token(cipher_text text, encryption_key text) OWNER TO postgres;

--
-- Name: deduct_variant_stock(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.deduct_variant_stock(p_variant_id uuid, p_qty integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
  rows_affected INT;
...
ALTER FUNCTION public.deduct_variant_stock(p_variant_id uuid, p_qty integer) OWNER TO postgres;

--
-- Name: encrypt_token(text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.encrypt_token(plain_text text, encryption_key text) RETURNS text
    LANGUAGE sql SECURITY DEFINER
    AS $$
...
ALTER FUNCTION public.encrypt_token(plain_text text, encryption_key text) OWNER TO postgres;

--
-- Name: restore_variant_stock(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.restore_variant_stock(p_variant_id uuid, p_qty integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE product_variants
...
ALTER FUNCTION public.restore_variant_stock(p_variant_id uuid, p_qty integer) OWNER TO postgres;
...
CREATE TABLE public.campaigns (
    ...
    CONSTRAINT campaigns_type_check CHECK ((type = ANY (ARRAY['discount'::text, 'freebie'::text, 'points_multiplier'::text, 'free_shipping'::text, 'bundle'::text])))
);
...
CREATE TABLE public.coupons (
    ...
    applicable_to text DEFAULT 'order'::text NOT NULL,
    tier_id uuid,
    CONSTRAINT coupons_applicable_to_check CHECK ((applicable_to = ANY (ARRAY['order'::text, 'subscription'::text, 'both'::text]))),
    CONSTRAINT coupons_type_check CHECK ((type = ANY (ARRAY['percentage'::text, 'fixed'::text])))
);
...
CREATE TABLE public.invoices (
    ...
    CONSTRAINT invoices_carrier_type_check CHECK ((carrier_type = ANY (ARRAY['phone'::text, 'natural_person'::text, 'love_code'::text]))),
    CONSTRAINT invoices_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'issued'::text, 'voided'::text]))),
    CONSTRAINT invoices_type_check CHECK ((type = ANY (ARRAY['B2C_2'::text, 'B2C_3'::text, 'B2B'::text])))
);
...
CREATE TABLE public.order_addresses (
    ...
    city text,
    postal_code text,
    CONSTRAINT order_addresses_address_type_check CHECK ((address_type = ANY (ARRAY['home'::text, 'cvs'::text]))),
    CONSTRAINT order_addresses_cvs_type_check CHECK ((cvs_type = ANY (ARRAY['711'::text, 'family'::text]))),
    CONSTRAINT order_addresses_type_check CHECK ((type = ANY (ARRAY['billing'::text, 'shipping'::text])))
);
...
CREATE TABLE public.orders (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT orders_payment_method_check CHECK ((payment_method = ANY (ARRAY['pchomepay'::text, 'linepay'::text, 'jkopay'::text]))),
    CONSTRAINT orders_payment_status_check CHECK ((payment_status = ANY (ARRAY['pending'::text, 'paid'::text, 'failed'::text, 'refunded'::text]))),
    CONSTRAINT orders_shipping_method_check CHECK ((shipping_method = ANY (ARRAY['cvs_711'::text, 'cvs_family'::text, 'home_delivery'::text]))),
    CONSTRAINT orders_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'shipped'::text, 'completed'::text, 'cancelled'::text, 'failed'::text])))
);
...
--
-- Name: post_tag_links; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.post_tag_links OWNER TO postgres;
...
--
-- Name: COLUMN products.shop_left; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.products.shop_left IS '商品左欄 — marketing copy, benefits, usage instructions (HTML)';


--
-- Name: COLUMN products.shop_middle; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.products.shop_middle IS '商品中欄 — ingredients, allergens, specs, nutrition (HTML)';


--
-- Name: COLUMN products.shop_right; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.products.shop_right IS '商品右欄 — brand values, charity info, storage instructions (HTML)';


--
-- Name: site_contents; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.subscription_plans (
    ...
    benefits jsonb,
    is_active boolean DEFAULT true NOT NULL,
    CONSTRAINT subscription_plans_interval_check CHECK (("interval" = ANY (ARRAY['monthly'::text, 'bimonthly'::text]))),
    CONSTRAINT subscription_plans_type_check CHECK ((type = ANY (ARRAY['membership'::text, 'replenishment'::text])))
);
...
CREATE TABLE public.subscriptions (
    ...
    payment_method text DEFAULT 'pchomepay'::text NOT NULL,
...
CREATE TABLE public.user_profiles (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    charity_savings numeric(12,2) DEFAULT 0,
    CONSTRAINT user_profiles_role_check CHECK ((role = ANY (ARRAY['customer'::text, 'admin'::text, 'editor'::text, 'viewer'::text])))
);
...
--
-- Name: coupon_uses coupon_uses_coupon_id_order_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: post_categories post_categories_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: post_tag_links post_tag_links_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: post_tags post_tags_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: site_contents site_contents_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.site_contents
    ADD CONSTRAINT site_contents_key_key UNIQUE (key);


--
-- Name: site_contents site_contents_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: subscription_orders subscription_orders_idempotency_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_orders
    ADD CONSTRAINT subscription_orders_idempotency_key_key UNIQUE (idempotency_key);
...
--
-- Name: webhook_events webhook_events_gateway_merchant_trade_no_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.webhook_events
    ADD CONSTRAINT webhook_events_gateway_merchant_trade_no_key UNIQUE (gateway, merchant_trade_no);
...
--
-- Name: idx_campaigns_tier; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_campaigns_tier ON public.campaigns USING btree (tier_id);
...
--
-- Name: idx_coupon_uses_coupon; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_coupon_uses_coupon ON public.coupon_uses USING btree (coupon_id);


--
-- Name: idx_coupon_uses_order; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_coupon_uses_order ON public.coupon_uses USING btree (order_id);


--
-- Name: idx_coupon_uses_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_coupon_uses_user ON public.coupon_uses USING btree (user_id);


--
-- Name: idx_coupons_tier; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_coupons_tier ON public.coupons USING btree (tier_id);
...
CREATE INDEX idx_invoices_issued_at ON public.invoices USING btree (issued_at DESC) WHERE (issued_at IS NOT NULL);
...
--
-- Name: idx_logistics_order; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_logistics_order ON public.logistics USING btree (order_id);


--
-- Name: idx_logistics_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_logistics_status ON public.logistics USING btree (status);
...
--
-- Name: idx_order_addresses_order; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_subscription_orders_subscription; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_subscription_orders_subscription ON public.subscription_orders USING btree (subscription_id);
...
--
-- Name: idx_user_profiles_membership_tier; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_profiles_membership_tier ON public.user_profiles USING btree (membership_tier_id);
...
--
-- Name: products products_search_vector_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.campaigns
    ADD CONSTRAINT campaigns_coupon_id_fkey FOREIGN KEY (coupon_id) REFERENCES public.coupons(id);


--
-- Name: campaigns campaigns_tier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.campaigns
    ADD CONSTRAINT campaigns_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.membership_tiers(id);
...
--
-- Name: coupon_uses coupon_uses_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: coupon_uses coupon_uses_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupon_uses
    ADD CONSTRAINT coupon_uses_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscriptions(id);
...
ALTER TABLE ONLY public.coupon_uses
    ADD CONSTRAINT coupon_uses_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id);


--
-- Name: coupons coupons_tier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.coupons
    ADD CONSTRAINT coupons_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.membership_tiers(id);


--
-- Name: orders fk_orders_invoice; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT fk_orders_invoice FOREIGN KEY (invoice_id) REFERENCES public.invoices(id);
...
ALTER TABLE ONLY public.logistics
    ADD CONSTRAINT logistics_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id);
...
ALTER TABLE ONLY public.media
    ADD CONSTRAINT media_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES auth.users(id);
...
--
-- Name: post_tag_links post_tag_links_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: post_tag_links post_tag_links_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: site_contents site_contents_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.site_contents
    ADD CONSTRAINT site_contents_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES auth.users(id);


--
-- Name: subscription_orders subscription_orders_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_orders
    ADD CONSTRAINT subscription_orders_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id);


--
-- Name: subscription_orders subscription_orders_subscription_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_orders
    ADD CONSTRAINT subscription_orders_subscription_id_fkey FOREIGN KEY (subscription_id) REFERENCES public.subscriptions(id);


--
-- Name: subscription_plans subscription_plans_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscription_plans
    ADD CONSTRAINT subscription_plans_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id);
...
--
-- Name: user_profiles user_profiles_membership_tier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION decrypt_token(cipher_text text, encryption_key text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.decrypt_token(cipher_text text, encryption_key text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.decrypt_token(cipher_text text, encryption_key text) TO anon;
GRANT ALL ON FUNCTION public.decrypt_token(cipher_text text, encryption_key text) TO authenticated;
GRANT ALL ON FUNCTION public.decrypt_token(cipher_text text, encryption_key text) TO service_role;


--
-- Name: FUNCTION deduct_variant_stock(p_variant_id uuid, p_qty integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.deduct_variant_stock(p_variant_id uuid, p_qty integer) TO anon;
GRANT ALL ON FUNCTION public.deduct_variant_stock(p_variant_id uuid, p_qty integer) TO authenticated;
GRANT ALL ON FUNCTION public.deduct_variant_stock(p_variant_id uuid, p_qty integer) TO service_role;


--
-- Name: FUNCTION encrypt_token(plain_text text, encryption_key text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.encrypt_token(plain_text text, encryption_key text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.encrypt_token(plain_text text, encryption_key text) TO anon;
GRANT ALL ON FUNCTION public.encrypt_token(plain_text text, encryption_key text) TO authenticated;
GRANT ALL ON FUNCTION public.encrypt_token(plain_text text, encryption_key text) TO service_role;


--
-- Name: FUNCTION restore_variant_stock(p_variant_id uuid, p_qty integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.restore_variant_stock(p_variant_id uuid, p_qty integer) TO anon;
GRANT ALL ON FUNCTION public.restore_variant_stock(p_variant_id uuid, p_qty integer) TO authenticated;
GRANT ALL ON FUNCTION public.restore_variant_stock(p_variant_id uuid, p_qty integer) TO service_role;
...
--
-- Name: TABLE coupon_uses; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE logistics; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.logistics TO anon;
GRANT ALL ON TABLE public.logistics TO authenticated;
GRANT ALL ON TABLE public.logistics TO service_role;
...
--
-- Name: TABLE order_addresses; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.order_addresses TO anon;
GRANT ALL ON TABLE public.order_addresses TO authenticated;
GRANT ALL ON TABLE public.order_addresses TO service_role;
...
--
-- Name: TABLE post_tag_links; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.post_tag_links TO anon;
GRANT ALL ON TABLE public.post_tag_links TO authenticated;
GRANT ALL ON TABLE public.post_tag_links TO service_role;
...
--
-- Name: TABLE site_contents; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.site_contents TO anon;
GRANT ALL ON TABLE public.site_contents TO authenticated;
GRANT ALL ON TABLE public.site_contents TO service_role;
...
\unrestrict 8qkaYjPDcEpiqT9b2pJf3sePwBCV4BCHdCqbskATWFfA2yxCwvMMsB8fLEwqmyI
