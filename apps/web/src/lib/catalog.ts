...
export type Product = { id: string; name: string; slug: string; description: string | null; images: string[] | null; is_active: boolean; category_id: string | null; created_at: string; min_price?: number; max_price?: number; total_stock?: number; sales_count?: number }
